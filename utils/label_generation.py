...
def process_grasp_labels(end_points):
    ...
    for i in range(len(clouds)):
        ...
        grasp_points = end_points['grasp_points_list'][i][0] #(Np, 3)
        grasp_labels = end_points['grasp_labels_list'][i][0] #(Np, V, A, D)
        grasp_offsets = end_points['grasp_offsets_list'][i][0] #(Np, V, A, D, 3)
        grasp_tolerance = end_points['grasp_tolerance_list'][i][0] #(Np, V, A, D)
